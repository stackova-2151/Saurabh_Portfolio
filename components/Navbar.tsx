    ...
    >
      ...
      >
        ...
        <motion.button
          ...
          className="font-semibold text-text-primary text-sm hidden sm:block transition-colors duration-200 hover:text-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50 rounded"
          style={{ textShadow: "none" }}
          onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.textShadow = "0 0 12px rgba(59,130,246,0.45)"; }}
